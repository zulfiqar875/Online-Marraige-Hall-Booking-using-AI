...
<body class="bg-dark">
    ...
    <form action="{{url('\onwerlogin',$book->OID)}}" method="post" class="text-light">
        @csrf
            ...
            <div class="hallinfo ml-5 mr-5 mt-4">
                ...
                <div class="row mt-2">
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="row p-3 ">
                            <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
                                <select name="dish1" id="d1" value="" required class="form-control">
                            ...
                            <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
                                <select name="dish2" id="d2" value="" required class="form-control">
                            ...
                            <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
                                <select name="dish3" id="d3" value="" required class="form-control">
                        ...
                        <div class="row p-3">
                            <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
                                <select name="dish4" id="d4" value="" required class="form-control">
                            ...
                            <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
                                <select name="dish5" id="d5" value="" required class="form-control">
                            ...
                            <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
                                <select name="dish6" id="d6" value="" required class="form-control">
                ...
                <div class="row mt-2 p-3 text-dark">
                    ...
                    <!-- <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
                        <input type="text" name="cfname"  placeholder="Customer Father Name" class="form-control">
                    </div>
                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
                        <input type="text" name="ccnic" placeholder="Customer CNIC" class="form-control">
                    </div> -->
                </div>

                <h5>Client infornation</h5>
                <div class="row mt-2 p-3 text-dark">
                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
                        <input type="text" name="cname" required  placeholder="Customer Full Name" class="form-control">
                    </div>
                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
                        <input type="text" name="cfname" required  placeholder="Customer Father Name" class="form-control">
                    </div>
                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
                        <input type="text" name="ccnic" required placeholder="Customer CNIC" class="form-control">
                    </div>
                </div>
                <div class="row mt-2 pl-3 pt-2 pr-3">
                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
                        <input type="text" name="cphone" required placeholder="Customer Phone No" class="form-control">
                    </div>
                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
                        <input type="text" name="cemail" required placeholder="Customer Email" class="form-control">
                    </div>
                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
                        <input type="text" name="cpassword" required  placeholder="Password For Account" class="form-control">
                    </div>
                </div>
